 ...
 * Filename:
 * ---------
 *	 even_hlt_front_s5k4h7mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "even_hlt_front_s5k4h7_camera_sensor"
#define LOG_INF(format, args...)pr_info(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
/* Shipei.Chen@Cam.Drv, 20200414, otp porting for even_hlt_front_s5k4h7!*/
...
extern char EVEN_HLT_FRONT_S5K4H7_OTP_CheckID(void);
extern void EVEN_HLT_FRONT_S5K4H7_OTP_Setting(void);
extern void EVEN_HLT_FRONT_S5K4H7_OTP_Release(void);
#endif
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id =EVEN_HLT_FRONT_S5K4H7_SENSOR_ID,	/*EVEN_HLT_FRONT_S5K4H7_SENSOR_ID = 0x487D */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{3264, 2448, 0, 306, 3264, 1836, 3264, 1836,
...
#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
unsigned char even_hlt_front_s5k4h7_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void even_hlt_front_s5k4h7_write_cmos_sensor(u16 addr, u32 para)
{
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if (pre_frame_flag != 0) {
		if (imgsensor.frame_length >= pre_frame_length) {
			litter_first = 1;
		} else {
			litter_first = 0;
		}
		printk("lch_debug new:%d, pre:%d, flag=%d\n", imgsensor.frame_length, pre_frame_length, litter_first);
	}
	...
	if (imgsensor.autoflicker_en == KAL_TRUE) {
		...
		if (realtime_fps >= 297 && realtime_fps <= 305) {
			...
			if (litter_first) {
				printk("lch_debug 1 litter_first:%d\n", litter_first);
				write_cmos_sensor_8(0x0340,imgsensor.frame_length >> 8);
				write_cmos_sensor_8(0x0341,imgsensor.frame_length & 0xFF);
			}else {
				printk("lch_debug 2 litter_first:%d\n", litter_first);
				write_cmos_sensor_8(0x0341,imgsensor.frame_length & 0xFF);
				write_cmos_sensor_8(0x0340,imgsensor.frame_length >> 8);
			}
		}
	...
	if (pre_frame_flag == 0) {
		pre_frame_flag = 1;
		printk("lch_debug first pre_frame_flag:%d\n", pre_frame_flag);
	}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	return gain;
}				/*  EVEN_HLT_FRONT_S5K4H7MIPI_SetGain  */
...
static kal_uint16 even_hlt_front_s5k4h7_init_setting[] = {
	0x0100, 0x00,
	0x0B05, 0x01,
	0x3074, 0x06,
	0x3075, 0x2F,
	...
	0x302D, 0x0B,
	0x302E, 0x09,
/*wenhui.chen@Camera.Driver, 20200507, add for mipi test*/
	0x392F, 0x01,
	0x3930, 0x80,
};
...
static kal_uint16 even_hlt_front_s5k4h7_cap_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 even_hlt_front_s5k4h7_cap1_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 even_hlt_front_s5k4h7_normal_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 even_hlt_front_s5k4h7_hs_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 even_hlt_front_s5k4h7_slim_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
{
	table_write_cmos_sensor(even_hlt_front_s5k4h7_init_setting,
		sizeof(even_hlt_front_s5k4h7_init_setting) / sizeof(kal_uint16));
}				/*  EVEN_HLT_FRONT_S5K4H7MIPI_Sensor_Init  */


static void preview_setting(void)
{
	table_write_cmos_sensor(even_hlt_front_s5k4h7_preview_setting,
		sizeof(even_hlt_front_s5k4h7_preview_setting) / sizeof(kal_uint16));
	#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
	EVEN_HLT_FRONT_S5K4H7_OTP_Setting();
	#endif
}				/*  EVEN_HLT_FRONT_S5K4H7MIPI_Capture_Setting  */

static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 150) {
		table_write_cmos_sensor(even_hlt_front_s5k4h7_cap1_setting,
			sizeof(even_hlt_front_s5k4h7_cap1_setting) / sizeof(kal_uint16));
	} else {
		table_write_cmos_sensor(even_hlt_front_s5k4h7_cap_setting,
			sizeof(even_hlt_front_s5k4h7_cap_setting) / sizeof(kal_uint16));
	}
	#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
	EVEN_HLT_FRONT_S5K4H7_OTP_Setting();
	#endif
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(even_hlt_front_s5k4h7_normal_video_setting,
		sizeof(even_hlt_front_s5k4h7_normal_video_setting) / sizeof(kal_uint16));
	#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
	EVEN_HLT_FRONT_S5K4H7_OTP_Setting();
	#endif
}
...
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(even_hlt_front_s5k4h7_hs_video_setting,
		sizeof(even_hlt_front_s5k4h7_hs_video_setting) / sizeof(kal_uint16));
	#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
	EVEN_HLT_FRONT_S5K4H7_OTP_Setting();
	#endif
}
...
{
	LOG_INF("E");
	table_write_cmos_sensor(even_hlt_front_s5k4h7_slim_video_setting,
		sizeof(even_hlt_front_s5k4h7_slim_video_setting) / sizeof(kal_uint16));
	#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
	EVEN_HLT_FRONT_S5K4H7_OTP_Setting();
	#endif
}
...
/* Shipei.Chen@Cam.Drv, 20200409, sensor porting for 206A1*/
	...
	#ifdef EVEN_HLT_FRONT_S5K4H7_OTP_ENABLE
	printk("EVEN_HLT_FRONT_S5K4H7_OTP_CheckID();\n");
	if(EVEN_HLT_FRONT_S5K4H7_MODULE_ID==EVEN_HLT_FRONT_S5K4H7_OTP_CheckID())
	{
		*sensor_id = imgsensor_info.sensor_id;
	...
	else
	{
		...
		EVEN_HLT_FRONT_S5K4H7_OTP_Release();
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	printk("EVEN_HLT_FRONT_S5K4H7_OTP_CheckID successfully...\n");
	#endif
	return ERROR_NONE;
}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("PLATFORM:MT6765,MIPI 2LANE\n");
	//sensor have two i2c address 0x6c 0x6d & 0x21 0x20,
	//we should detect the module used i2c address
	//while (imgsensor_info.i2c_addr_table[i] != 0xff) {
	spin_lock(&imgsensor_drv_lock);
	...
	do {
		sensor_id = return_sensor_id();
		printk("even s5k4h7 sensor id:0x%x",sensor_id);
		if (sensor_id == 0x487D) {
			sensor_id = imgsensor_info.sensor_id;
	...
	{
		// if Sensor ID is not correct, Must set *sensor_id to 0xFFFF
		EVEN_HLT_FRONT_S5K4H7_OTP_Release();
		sensor_id = 0xFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
	return ERROR_NONE;
}		/* even_hlt_front_s5k4h7MIPIPreview */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_FRAMERATE:
		spin_lock(&imgsensor_drv_lock);
		/*wenhui.chen@Camera.Driver, 20200611, modify for monkey*/
...
UINT32 EVEN_HLT_FRONT_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      EVEN_HLT_FRONT_S5K4H7_MIPI_RAW_SensorInit      */
