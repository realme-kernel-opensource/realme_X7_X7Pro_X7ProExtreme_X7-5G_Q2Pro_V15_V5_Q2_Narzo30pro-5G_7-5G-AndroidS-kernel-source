...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_21651,
    .checksum_value = 0xf17e8986,
    ...
    .min_gain_iso = 100,
    .gain_step = 1,
    .gain_type = 0, //0-SONY; 1-OV; 2 - SUMSUN; 3 -HYNIX; 4 -GC
    .margin = 10,
    .min_shutter = 1,
...
static void read_module_data(void)
{
    ...
    gImgEepromInfo.camNormdata[2][48] = 0xFF;
    gImgEepromInfo.camNormdata[2][49] = 0xFF;
    ...
    for(i = 2; i < 8; i++) {
       ...
       gImgEepromInfo.camNormdata[2][i+48] = 0xFF;
    }

    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
       gImgEepromInfo.camNormdata[2][8+i] = Eeprom_1ByteDataRead(0xB0+i, 0xA2);
    }
    vcmID = (Eeprom_1ByteDataRead(0xb, 0xA2) << 8) | Eeprom_1ByteDataRead(0xa, 0xA2);
    lensID = (Eeprom_1ByteDataRead(0x9, 0xA2) << 8) | Eeprom_1ByteDataRead(0x8, 0xA2);
...
static void write_shutter(kal_uint32 shutter)
{
    ...
    if (shutter > (imgsensor_info.max_frame_length - imgsensor_info.margin)) {
        ...
        write_cmos_sensor_8(0x0104, 0x01);
        write_cmos_sensor_8(0x3060,
                read_cmos_sensor(0x3060) | (l_shift & 0x7));
        write_cmos_sensor_8(0x0340, imgsensor.frame_length >> 8);
        write_cmos_sensor_8(0x0341, imgsensor.frame_length & 0xFF);
        write_cmos_sensor_8(0x0104, 0x00);
        ...
        write_cmos_sensor_8(0x0104, 0x01);
        write_cmos_sensor_8(0x3060, read_cmos_sensor(0x3060) & 0xf8);
        write_cmos_sensor_8(0x0340, imgsensor.frame_length >> 8);
        write_cmos_sensor_8(0x0341, imgsensor.frame_length & 0xFF);
        write_cmos_sensor_8(0x0104, 0x00);
        imgsensor.current_ae_effective_frame = 2;
...
{
    table_write_cmos_sensor(custom4_setting_array,
                    sizeof(custom4_setting_array)/sizeof(kal_uint16));
}

static void custom5_setting(void)
{
    table_write_cmos_sensor(custom5_setting_array,
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:
        /* part1 : if support auto_exten_en */
        *(feature_data + 1) = 1;
        /* part2:  margin info by scenario */
