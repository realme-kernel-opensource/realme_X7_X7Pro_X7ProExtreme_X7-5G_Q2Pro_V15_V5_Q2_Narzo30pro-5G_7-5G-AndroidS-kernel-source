...
static struct imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC02M1_SENSOR_ID_21305,
    ...
    .slim_video = {
        ...
        .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//sensor output first pixel color R
...
#define EEPROM_SLAVE_ADDRESS (0xA4)

static void Read_Eeprom_Data(void)
{
    int i = 0;
//    struct CAMERA_DEVICE_INFO * gImgEepromInfo = &gImgEepromInfo_21305;
    /*Read normal eeprom data*/
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][0] = Eeprom_1ByteDataRead(0x00, EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][1] = Eeprom_1ByteDataRead(0x01, EEPROM_SLAVE_ADDRESS);
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, EEPROM_SLAVE_ADDRESS);
    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo.pCamModuleInfo[IMGSENSOR_SENSOR_IDX_SUB2].name,
                                    gImgEepromInfo.pCamModuleInfo[IMGSENSOR_SENSOR_IDX_SUB2].version,
                                    imgsensor_info.module_id);
    for(i = 2; i < 8; i++) {
        gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][i] = Eeprom_1ByteDataRead(0x04+i, EEPROM_SLAVE_ADDRESS);
    }
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
        gImgEepromInfo.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][8+i] = Eeprom_1ByteDataRead(0xE0+i, EEPROM_SLAVE_ADDRESS);
    }
    gImgEepromInfo.i4CurSensorIdx = IMGSENSOR_SENSOR_IDX_SUB2;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    if((ANALOG_GAIN_1<= iReg)&&(iReg < ANALOG_GAIN_2))
    {
        ...
        LOG_INF("GC02M1MIPI analogic gain 1x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_2<= iReg)&&(iReg < ANALOG_GAIN_3))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 1.185x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_3<= iReg)&&(iReg < ANALOG_GAIN_4))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 1.4x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_4<= iReg)&&(iReg < ANALOG_GAIN_5))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 1.659x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_5<= iReg)&&(iReg < ANALOG_GAIN_6))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 2.0x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_6<= iReg)&&(iReg < ANALOG_GAIN_7))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 2.37x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_7<= iReg)&&(iReg < ANALOG_GAIN_8))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 2.8x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_8<= iReg)&&(iReg < ANALOG_GAIN_9))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 3.318x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_9<= iReg)&&(iReg < ANALOG_GAIN_10))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 4.0x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_10<= iReg)&&(iReg < ANALOG_GAIN_11))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 4.74x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_11<= iReg)&&(iReg < ANALOG_GAIN_12))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 5.6x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_12<= iReg)&&(iReg < ANALOG_GAIN_13))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 6.636x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_13<= iReg)&&(iReg < ANALOG_GAIN_14))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 8.0x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_14<= iReg)&&(iReg < ANALOG_GAIN_15))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 9.48x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else if((ANALOG_GAIN_15<= iReg)&&(iReg < ANALOG_GAIN_16))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 11.2x, GC02M1MIPI add pregain = %d\n",temp);
    }
    else //if ((ANALOG_GAIN_16<= iReg)&&(iReg < ANALOG_GAIN_17))
    {
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 13.2725x, GC02M1MIPI add pregain = %d\n",temp);
    }
    /*else
    {
        write_cmos_sensor(0xfe,  0x00);
        ...
        write_cmos_sensor(0xb1, (temp>>8)&0x3f);
        write_cmos_sensor(0xb2, (temp&0xff));
        LOG_INF("GC02M1MIPI analogic gain 16x, GC02M1MIPI add pregain = %d\n",temp);
    }*/
...
static kal_uint16 addr_data_pair_init_carr_gc02m1[] = {
    /*system*/
    0xfc,0x01,
    0xf4,0x41,
    0xf5,0xc0,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(addr_data_pair_init_carr_gc02m1,
        sizeof(addr_data_pair_init_carr_gc02m1) / sizeof(kal_uint16));
            ...
            if (*sensor_id == GC02M1_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(deviceInfo_register_value == 0x00){
                    Eeprom_DataInit(IMGSENSOR_SENSOR_IDX_SUB2, imgsensor_info.sensor_id);
