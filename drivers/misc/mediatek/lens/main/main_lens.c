...
/* 2022.03.07 lizhiyuan@Drv.Camera 20171 add for lens PID parameters update*/
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
    #ifdef OPLUS_FEATURE_CAMERA_COMMON
    /*wuhao@Camera.Driver 20211022 add for even af*/
	...
	af_pinctrl_set(AF_PINCTRL_PIN_HWEN,
        ...
        if (!is_project(19165)) {
            ...
            AFRegulatorCtrl(2);
                ...
                /*Wenjun@Cam.Drv,20190928,add for 19165 AF*/
