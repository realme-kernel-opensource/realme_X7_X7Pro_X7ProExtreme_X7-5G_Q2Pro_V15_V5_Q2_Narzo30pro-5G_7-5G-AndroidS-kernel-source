...
/*v-peng.song@Camera.Driver add for 20817 decouple 20210305*/
...
/* lilin@CAMERA.TUNING,2021/12/27,Add for mt6833 */
...
{
	#ifdef OPLUS_FEATURE_CAMERA_COMMON
	/*v-peng.song@Camera.Driver add for 20817 add 62.5mA 20210305*/
	...
	#ifdef OPLUS_FEATURE_CAMERA_COMMON
	if (is_project(20827) || is_project(20831) || is_project(21881) || is_project(21882)){
...
static int mt6360_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	case FLASH_IOC_GET_HW_TIMEOUT:
		...
		#ifdef OPLUS_FEATURE_CAMERA_COMMON
		/*v-peng.song@Camera.Driver add for 20817 strobe timeout 20210305*/
...
{
	#ifdef OPLUS_FEATURE_CAMERA_COMMON
	/* v-peng.song@Cam.Drv, 20210218, modify for 20817 scenario for hardware test */
	int scenario;
	#endif
...
static int mt6360_probe(struct platform_device *pdev)
{
	...
	#ifdef OPLUS_FEATURE_CAMERA_COMMON
	/* v-peng.song@Cam.Drv, 20210218, modify for 20817 strobe mode timeout for hardware test */
