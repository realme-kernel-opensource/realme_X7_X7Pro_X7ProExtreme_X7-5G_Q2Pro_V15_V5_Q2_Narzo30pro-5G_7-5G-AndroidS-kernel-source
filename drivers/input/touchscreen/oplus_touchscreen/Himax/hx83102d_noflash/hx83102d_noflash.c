...
void himax_read_OPLUS_FW_ver(void)
{
    uint8_t cmd[4];
    uint8_t data[4];
    uint32_t touch_ver = 0;
    /*oplus fw id bin address : 0xc014 Tp ic address : 0x 10007014*/
    cmd[3] = 0x10;
    cmd[2] = 0x00;
    cmd[1] = 0x70;
    cmd[0] = 0x14;
...
static uint32_t hx83102d_get_fw_id(struct chip_data_hx83102d *chip_info)
{
    ...
    uint8_t cmd[4];
    uint8_t data[64];
    /*oplus fw id bin address : 0xc014	 , 49172	Tp ic address : 0x 10007014*/
...
static int hx83102d_reset(void *chip_data)
{
    ...
    /*Yulianghan@RM.PSW.BSP.TP, 2018/09/07, add for hx83112a_noflash lcd esd TP irq exception in oplus 18612*/
#ifdef CONFIG_TOUCHPANEL_MTK_PLATFORM
    enable_irq(chip_info->hx_irq);
#endif
    return ret;
