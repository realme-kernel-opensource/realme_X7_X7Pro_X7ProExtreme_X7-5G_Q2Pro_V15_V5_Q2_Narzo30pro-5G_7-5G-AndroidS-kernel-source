...
struct mtk_panel_params {
	...
	#ifdef OPLUS_BUG_STABILITY
	/* Zhijun.Ye@MM.Display.LCD 2022/01/13, Add for ssc config */
	...
	/* #ifdef OPLUS_BUG_STABILITY */
	/* Zhijun.Ye@MM.Display.LCD, 2021/06/29, add for lcd */
	...
	/* chenjun@MM.Display.LCD.Feature, add for serial num read */
	...
	int brightness_min;
	#endif
	/* Xupengcheng@MM.Display.LCD.Feature, add for Global dre switch */
