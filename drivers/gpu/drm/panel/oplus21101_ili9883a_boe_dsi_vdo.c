...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x00, 0x13, 0x42, 0x72, 0x50, 0xAE, 0xE3, 0x0B, 0x3D, 0x95, \
	0x65, 0xA5, 0xDA, 0x07, 0xAA, 0x34, 0x64, 0x9C, 0xBF, 0xFE, 0xE9, 0x0C, 0x3A, 0x72, 0x3F, 0x9F, 0xDC, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0xE1, 0x00, 0x00, 0x13, 0x42, 0x72, 0x50, 0xAE, 0xE3, 0x0B, 0x3D, 0x95, \
	0x65, 0xA5, 0xDA, 0x07, 0xAA, 0x34, 0x64, 0x9C, 0xBF, 0xFE, 0xE9, 0x0C, 0x3A, 0x72, 0x3F, 0x9F, 0xDC, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x06);
		...
		void *handle, unsigned int level)
{
	...
	char bl_tb10[] = {0xFF, 0x98, 0x83, 0x00};
	char bl_tb11[] = {0x29, 0x00};
	pr_err("%s backlight = %d\n", __func__, level);
...
{
	char bl_tb0[] = {0x51, 0x07, 0xff};
	char bl_tb1[] = {0xFF, 0x98, 0x83, 0x00};
	char bl_tb2[] = {0x29, 0x00};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus_ili9883a_boe_vdo_lcm_drv",
			.owner = THIS_MODULE,
