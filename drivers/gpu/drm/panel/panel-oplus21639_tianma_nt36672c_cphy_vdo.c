...
// endif
	...
	//Max gain
	tianma_dcs_write_seq_static(ctx, 0x0A, 0x5D);
	tianma_dcs_write_seq_static(ctx, 0x0B, 0x5D);
	tianma_dcs_write_seq_static(ctx, 0x0C, 0x5D);
	tianma_dcs_write_seq_static(ctx, 0x0D, 0x3F);
	//Image_Compensation
	tianma_dcs_write_seq_static(ctx, 0x19, 0x3F);
	tianma_dcs_write_seq_static(ctx, 0x1A, 0x30);
	tianma_dcs_write_seq_static(ctx, 0x1B, 0x1A);
	tianma_dcs_write_seq_static(ctx, 0x1C, 0x10);
	tianma_dcs_write_seq_static(ctx, 0x1D, 0x0B);
	tianma_dcs_write_seq_static(ctx, 0x1E, 0x0B);
	tianma_dcs_write_seq_static(ctx, 0x1F, 0x0C);
	tianma_dcs_write_seq_static(ctx, 0x20, 0x0D);
	tianma_dcs_write_seq_static(ctx, 0x21, 0x0F);
	tianma_dcs_write_seq_static(ctx, 0x22, 0x11);
	tianma_dcs_write_seq_static(ctx, 0x23, 0x12);
	tianma_dcs_write_seq_static(ctx, 0x24, 0x13);
	tianma_dcs_write_seq_static(ctx, 0x25, 0x14);
	tianma_dcs_write_seq_static(ctx, 0x26, 0x15);
	tianma_dcs_write_seq_static(ctx, 0x27, 0x15);
	tianma_dcs_write_seq_static(ctx, 0x28, 0x14);
	...
	//PWM_5500h_0x01
	tianma_dcs_write_seq_static(ctx, 0x30, 0xEF);
    	tianma_dcs_write_seq_static(ctx, 0x31, 0xEE);
	...
	//PWM_5500h_02
	tianma_dcs_write_seq_static(ctx, 0x45, 0xD8);
    	tianma_dcs_write_seq_static(ctx, 0x46, 0xD6);
	...
	//PWM_5500h_03
	tianma_dcs_write_seq_static(ctx, 0x58, 0xD2);
    	tianma_dcs_write_seq_static(ctx, 0x59, 0xD0);
...
static const struct drm_display_mode default_mode = {
	.clock = 300591,
	.hdisplay = 1080,
	.hsync_start = 1080 + 290,
	.hsync_end = 1080 + 290 + 22,
	.htotal = 1080 + 290 + 22 + 22,
	.vdisplay = 2408,
...
static int tianma_get_modes(struct drm_panel *panel)
{
	...
	panel->connector->display_info.width_mm = 72;
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "NT36672C_TM_ALICE_R", "tianma2048");
/* #ifdef OPLUS_BUG_STABILITY */
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
			...
			.name = "oplus21639_nt36672c_tm_cphy_dsi_vdo_lcm_drv",
			.owner = THIS_MODULE,
