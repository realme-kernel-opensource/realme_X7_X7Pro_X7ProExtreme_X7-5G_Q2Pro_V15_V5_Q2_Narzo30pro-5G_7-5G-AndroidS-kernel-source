...
static void lcm_panel_init(struct lcm *ctx)
{
	pr_info("SYQ %s+\n", __func__);
        ...
        lcm_dcs_write_seq_static(ctx, 0xB0, 0x04);
        lcm_dcs_write_seq_static(ctx, 0xB8, 0x06, 0x83, 0x28, 0x10, 0x0F, 0x44);
        lcm_dcs_write_seq_static(ctx, 0xB9, 0x06, 0x8C, 0x2E, 0x10, 0x19, 0xb1);
        lcm_dcs_write_seq_static(ctx, 0xBA, 0x06, 0x8C, 0x3C, 0x10, 0x29, 0xED);
        lcm_dcs_write_seq_static(ctx, 0xCE, 0x16, 0x40, 0x60, 0x78, 0x87, 0x94, 0x9e, 0xab, 0xb8, \
        0xc4, 0xcd, 0xd6, 0xde, 0xe5, 0xec, 0xf3, 0xff, 0x07, 0x0f, 0x04, 0x04, 0x00, 0x04, 0x8c); //LEDPWM=30KHz and 12bit DBV
...
static const struct of_device_id jdi_of_match[] = {
	{
		.compatible = "oplus2163b,truly,td4160,dphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus2163b_td4160_truly_hd_vdo_lcm_drv",
			.owner = THIS_MODULE,
