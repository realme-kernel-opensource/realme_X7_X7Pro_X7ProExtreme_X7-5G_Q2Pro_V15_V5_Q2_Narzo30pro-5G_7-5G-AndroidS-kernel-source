...
static struct LCM_setting_table lcm_aod_to_normal[] = {
	...
	{REGFLAG_CMD,4,{0xB4,0x50,0x80,0x80}},

	//add for corner
	{REGFLAG_CMD,3,{0xC0,0x01,0x02}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC1,0x38,0x0F,0x09,0x00,0x00,0x40,0xFD,0x00,0x3F,0xFE,0x72,0xE0,0xFF,0xFF,0xCD,0x00,0x00,0x00,0x0A,0x29,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC1,0x00,0x00,0x42,0x00,0x08,0xA8,0x33,0x60,0x03,0x30,0x0F,0x9A,0xF8,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC1,0x00,0x34,0x00,0x00,0x3E,0x08,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC2,0x30,0x0F,0x00,0x51,0x14,0x40,0xFA,0xF0,0x3F,0xFF,0xB5,0x54,0x3F,0xFD,0x60,0x3C,0x00,0x00,0x11,0x35,0xA4}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC2,0x00,0x3F,0x00,0x00,0xB5,0x09,0x33,0x90,0x04,0x26,0x0F,0xF7,0x8A,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC2,0x04,0x18,0x0C,0x04,0x29,0x1C,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC3,0x36,0x00,0x03,0x10,0x0D,0x99,0x0C,0xE8,0x00,0x00,0x00,0x00,0x3F,0xF3,0x10,0x90,0x80,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC3,0x03,0xA4,0x00,0x04,0x17,0x1C,0x33,0xC0,0x00,0x00,0x03,0x1C,0x8D,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC3,0x00,0x01,0x38,0x00,0x07,0x41,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC4,0x36,0x00,0x14,0x40,0x03,0xC1,0x11,0x70,0x00,0x04,0xD2,0x30,0x3F,0xFA,0x40,0x78,0x00,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC4,0x04,0x18,0x1D,0x04,0x37,0x99,0x33,0x20,0x00,0x00,0x03,0x7C,0xE1,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC4,0x94,0x18,0x43,0x94,0x29,0x53,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC5,0x30,0x0F,0x03,0x10,0x03,0x84,0xF9,0x70,0x3F,0xFD,0x58,0x20,0x3F,0xFD,0x4B,0x00,0x80,0x00,0x6C,0x87,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC5,0x00,0x08,0x09,0x00,0x3E,0x41,0x33,0x40,0x0B,0xD0,0x0F,0xC8,0xCA,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC5,0x90,0x0E,0x43,0x90,0x1F,0x53,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC6,0x22,0x0F,0x03,0x10,0x0D,0x99,0xF3,0x18,0x00,0x01,0x69,0x60,0x00,0x09,0xF5,0xF8,0xFF,0xFE,0xBF,0x74,0x50}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC6,0x93,0xA4,0x43,0x94,0x17,0x5F,0x33,0xCF,0xF3,0x6C,0x00,0x1C,0x73,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC6,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD,4,{0x6F,0x00}},
	{REGFLAG_CMD,4,{0xC7,0x2A,0x0F,0x14,0x40,0x03,0xC1,0xEE,0x90,0x00,0x0D,0x44,0x70,0xC0,0x02,0x1C,0x90,0xFF,0xFE,0x18,0xB2,0x30}},
	{REGFLAG_CMD,4,{0x6F,0x15}},
	{REGFLAG_CMD,4,{0xC7,0x84,0x18,0xC6,0x94,0x37,0x42,0x33,0x9F,0xF0,0xFC,0x00,0x7C,0x1F,0x00,0x00}},
	{REGFLAG_CMD,4,{0x6F,0x24}},
	{REGFLAG_CMD,4,{0xC7,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC8,0x24,0x00,0x03,0x10,0x0D,0x99,0x0C,0xE8,0x3F,0xFB,0xD6,0x40,0x00,0x04,0x29,0xC0,0x80,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC8,0x90,0x20,0x43,0x90,0x93,0x5F,0x33,0xC0,0x00,0x00,0x0C,0xE4,0x73,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xC9,0x2C,0x00,0x14,0x40,0x03,0xC1,0x11,0x70,0x3F,0xED,0xD4,0x10,0xC0,0x00,0x00,0x00,0x80,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xC9,0x80,0x00,0xC6,0x90,0x1F,0x42,0x33,0x90,0x00,0x00,0x0C,0x84,0x1F,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xC9,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xCA,0x21,0x00,0x04,0x41,0x04,0x41,0x00,0x00,0x3F,0xFE,0xE7,0x3E,0x3F,0xFE,0xE7,0x3E,0x00,0x00,0x12,0x18,0x81}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xCA,0x00,0x42,0x23,0x00,0x63,0x44,0x33,0x90,0x04,0x41,0x0F,0xDF,0xDF,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xCA,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xCB,0x27,0x00,0x04,0x41,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xFE,0xF8,0x00,0x00,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xCB,0x00,0x64,0x23,0x00,0x84,0x44,0x33,0x90,0x00,0x00,0x03,0x21,0xE0,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xCB,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xCC,0x2D,0x00,0x04,0x00,0x04,0x41,0x00,0x00,0x3F,0xFE,0xF8,0x00,0x00,0x00,0x00,0x00,0x80,0x00,0x00,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xCC,0x00,0x42,0x45,0x00,0x63,0x65,0x33,0x60,0x00,0x00,0x0C,0xE0,0x21,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	{REGFLAG_CMD, 8,{0xCC,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},

	{REGFLAG_CMD, 2,{0x6F,0x00}},
	{REGFLAG_CMD,22,{0xCD,0x2B,0x00,0x04,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xF0,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x15}},
	{REGFLAG_CMD,16,{0xCD,0x00,0x64,0x45,0x00,0x85,0x66,0x44,0x6F,0xFC,0x00,0x00,0x20,0x20,0x00,0x00}},
	{REGFLAG_CMD, 2,{0x6F,0x24}},
	...
	//{REGFLAG_CMD,8,{0xC3,0x8D,0x01,0x99,0xD0,0x20,0x81,0x00}},
	{REGFLAG_END_OF_TABLE, 0x00, {}}
};

static struct LCM_setting_table lcm_seed_setting[] = {
	{REGFLAG_CMD,6,{0xF0,0x55,0xAA,0x52,0x08,0x00}},
	{REGFLAG_CMD,2,{0xB2,0xC0}},

	{REGFLAG_CMD,37,{0xB3,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0xFF,0x0F,0xFF}},

	{REGFLAG_CMD,2,{0x6F,0x2C}},
	{REGFLAG_CMD,39,{0xB3,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48}},
	{REGFLAG_CMD,39,{0xB4,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C}},
...
static struct LCM_setting_table lcm_seed_exit[] = {
	{REGFLAG_CMD,6,{0xF0,0x55,0xAA,0x52,0x08,0x00}},
	{REGFLAG_CMD,2,{0xB2,0x50}},

	{REGFLAG_CMD,37,{0xB3,0x00,0x08,0x00,0x14,0x00,0x14,0x00,0x29,0x00,0x29,0x00,0x6A,0x00,0x6A,0x00,0xF6,0x00,0xF6,0x02,0x28,0x02,0x28,0x02,0x29,0x02,0x29,0x04,0xCC,0x04,0xCC,0x07,0xFF,0x07,0xFF,0x0F,0xFF}},
	{REGFLAG_CMD,2,{0x6F,0x2C}},
	{REGFLAG_CMD,39,{0xB3,0x09,0x80,0x09,0x4F,0x08,0x8C,0x08,0x8C,0x08,0x3D,0x08,0x3D,0x07,0x37,0x07,0x37,0x05,0x0F,0x05,0x0F,0x00,0x4B,0x00,0x4B,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48,0x00,0x48}},
	{REGFLAG_CMD,39,{0xB4,0x0E,0x40,0x0D,0xF6,0x0C,0xD2,0x0C,0xD2,0x0C,0x5B,0x0C,0x5B,0x0A,0xD2,0x0A,0xD2,0x07,0x96,0x07,0x96,0x00,0x70,0x00,0x70,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C,0x00,0x6C}},
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0xB4,0x50,0x80,0x80);

	//add for corner
	lcm_dcs_write_seq_static(ctx,0xC0,0x01,0x02);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC1,0x38,0x0F,0x09,0x00,0x00,0x40,0xFD,0x00,0x3F,0xFE,0x72,0xE0,0xFF,0xFF,0xCD,0x00,0x00,0x00,0x0A,0x29,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC1,0x00,0x00,0x42,0x00,0x08,0xA8,0x33,0x60,0x03,0x30,0x0F,0x9A,0xF8,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC1,0x00,0x34,0x00,0x00,0x3E,0x08,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC2,0x30,0x0F,0x00,0x51,0x14,0x40,0xFA,0xF0,0x3F,0xFF,0xB5,0x54,0x3F,0xFD,0x60,0x3C,0x00,0x00,0x11,0x35,0xA4);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC2,0x00,0x3F,0x00,0x00,0xB5,0x09,0x33,0x90,0x04,0x26,0x0F,0xF7,0x8A,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC2,0x04,0x18,0x0C,0x04,0x29,0x1C,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC3,0x36,0x00,0x03,0x10,0x0D,0x99,0x0C,0xE8,0x00,0x00,0x00,0x00,0x3F,0xF3,0x10,0x90,0x80,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC3,0x03,0xA4,0x00,0x04,0x17,0x1C,0x33,0xC0,0x00,0x00,0x03,0x1C,0x8D,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC3,0x00,0x01,0x38,0x00,0x07,0x41,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC4,0x36,0x00,0x14,0x40,0x03,0xC1,0x11,0x70,0x00,0x04,0xD2,0x30,0x3F,0xFA,0x40,0x78,0x00,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC4,0x04,0x18,0x1D,0x04,0x37,0x99,0x33,0x20,0x00,0x00,0x03,0x7C,0xE1,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC4,0x94,0x18,0x43,0x94,0x29,0x53,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC5,0x30,0x0F,0x03,0x10,0x03,0x84,0xF9,0x70,0x3F,0xFD,0x58,0x20,0x3F,0xFD,0x4B,0x00,0x80,0x00,0x6C,0x87,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC5,0x00,0x08,0x09,0x00,0x3E,0x41,0x33,0x40,0x0B,0xD0,0x0F,0xC8,0xCA,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC5,0x90,0x0E,0x43,0x90,0x1F,0x53,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC6,0x22,0x0F,0x03,0x10,0x0D,0x99,0xF3,0x18,0x00,0x01,0x69,0x60,0x00,0x09,0xF5,0xF8,0xFF,0xFE,0xBF,0x74,0x50);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC6,0x93,0xA4,0x43,0x94,0x17,0x5F,0x33,0xCF,0xF3,0x6C,0x00,0x1C,0x73,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC6,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC7,0x2A,0x0F,0x14,0x40,0x03,0xC1,0xEE,0x90,0x00,0x0D,0x44,0x70,0xC0,0x02,0x1C,0x90,0xFF,0xFE,0x18,0xB2,0x30);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC7,0x84,0x18,0xC6,0x94,0x37,0x42,0x33,0x9F,0xF0,0xFC,0x00,0x7C,0x1F,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC7,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC8,0x24,0x00,0x03,0x10,0x0D,0x99,0x0C,0xE8,0x3F,0xFB,0xD6,0x40,0x00,0x04,0x29,0xC0,0x80,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC8,0x90,0x20,0x43,0x90,0x93,0x5F,0x33,0xC0,0x00,0x00,0x0C,0xE4,0x73,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xC9,0x2C,0x00,0x14,0x40,0x03,0xC1,0x11,0x70,0x3F,0xED,0xD4,0x10,0xC0,0x00,0x00,0x00,0x80,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xC9,0x80,0x00,0xC6,0x90,0x1F,0x42,0x33,0x90,0x00,0x00,0x0C,0x84,0x1F,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xC9,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xCA,0x21,0x00,0x04,0x41,0x04,0x41,0x00,0x00,0x3F,0xFE,0xE7,0x3E,0x3F,0xFE,0xE7,0x3E,0x00,0x00,0x12,0x18,0x81);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xCA,0x00,0x42,0x23,0x00,0x63,0x44,0x33,0x90,0x04,0x41,0x0F,0xDF,0xDF,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xCA,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xCB,0x27,0x00,0x04,0x41,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xFE,0xF8,0x00,0x00,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xCB,0x00,0x64,0x23,0x00,0x84,0x44,0x33,0x90,0x00,0x00,0x03,0x21,0xE0,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xCB,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xCC,0x2D,0x00,0x04,0x00,0x04,0x41,0x00,0x00,0x3F,0xFE,0xF8,0x00,0x00,0x00,0x00,0x00,0x80,0x00,0x00,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xCC,0x00,0x42,0x45,0x00,0x63,0x65,0x33,0x60,0x00,0x00,0x0C,0xE0,0x21,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xCC,0x00,0x00,0x00,0x00,0x00,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x6F,0x00);
	lcm_dcs_write_seq_static(ctx,0xCD,0x2B,0x00,0x04,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0xFF,0xF0,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x15);
	lcm_dcs_write_seq_static(ctx,0xCD,0x00,0x64,0x45,0x00,0x85,0x66,0x44,0x6F,0xFC,0x00,0x00,0x20,0x20,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0x6F,0x24);
	lcm_dcs_write_seq_static(ctx,0xCD,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	//corner end
	//----------------------- Page 1 ------------------------
	lcm_dcs_write_seq_static(ctx,0xF0,0x55,0xAA,0x52,0x08,0x01);
	//OSC track
	lcm_dcs_write_seq_static(ctx,0xC3,0x8D,0x01,0x96,0xD0,0x22,0x02,0x00);
	//OVP
	lcm_dcs_write_seq_static(ctx,0xC7,01);
...
static int lcm_prepare(struct drm_panel *panel)
{
	...
	if(power_mode == 2)
	{
		DDPINFO("%s + lcm_panel_init, TM resume status\n", __func__);
		lcm_panel_init(ctx);
	}
	ret = ctx->error;
	if (ret < 0)
...
static struct mtk_panel_params ext_params = {
	...
	.lcm_esd_check_table[1] = {
		.cmd = 0xFA, .count = 1, .para_list[0] = 0x00, .mask_list[0] = 0xFF,
	},
	/*
...
/* zhaohan@MM.Display.LCD.Feature, add for serial num read */
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0xC3,0x9A,0x01,0x99,0xD0,0x22,0x02,0x00);
		lcm_dcs_write_seq_static(ctx, 0x2C);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		lcm_dcs_write_seq_static(ctx, 0x2F, 0x01); /* 60 FPS */
...
/*#ifdef OPLUS_FEATURE_TP_BASIC*/
        if(stage == BEFORE_DSI_POWERDOWN) {
                pr_info("[TP] ready charge to %d hz", m->vrefresh);
                lcd_tp_refresh_switch(m->vrefresh);
        }
/*#endif OPLUS_FEATURE_TP_BASIC*/
	pr_info("mode_switch m->vrefresh is %d ", m->vrefresh);
...
static struct LCM_setting_table lcm_normal_to_aod_sam[] = {
	...
	{REGFLAG_CMD, 3, {0xFA,0x02,0x02}},
	{REGFLAG_CMD, 2, {0x6F,0x14}},
	{REGFLAG_CMD, 2, {0xF3,0x00}},
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	ctx->ldo_gpio = devm_gpiod_get(ctx->dev, "ldo", GPIOD_OUT_HIGH);
	gpiod_set_value(ctx->ldo_gpio, 1);
	devm_gpiod_put(ctx->dev, ctx->ldo_gpio);
	usleep_range(10 * 1000, 11 * 1000);
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	msleep(5);
	ctx->ldo_gpio = devm_gpiod_get(ctx->dev, "ldo", GPIOD_OUT_HIGH);
	gpiod_set_value(ctx->ldo_gpio, 0);
	devm_gpiod_put(ctx->dev, ctx->ldo_gpio);
	msleep(10);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "21015_TM_NT37701_42", "TM_nt37701_2048");
	ctx->hbm_en = false;
	/* #ifdef OPLUS_BUG_DISPLAY */
	oplus_max_normal_brightness = SILKY_MAX_NORMAL_BRIGHTNESS;
	/* #endif OPLUS_BUG_DISPLAY */
	pr_info("%s zjb+\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus21015_tianma_nt37701_42_1080p_dsi_cmd",
		.owner = THIS_MODULE,
