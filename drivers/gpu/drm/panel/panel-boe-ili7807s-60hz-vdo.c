...
#endif
// wangcheng@ODM.Multimedia.LCD  2021/08/12 add esd recorvery brightness
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-boe-ili7807s-60hz-vdo",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("boe ili7807s 60HZ VDO LCD Panel Driver");
